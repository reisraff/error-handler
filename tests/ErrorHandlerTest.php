...
class ErrorHandlerTest extends TestCase
{
    ...
    public function testGifFormatter()
    {
        ...
        $response = Dispatcher::run([
            (new ErrorHandler())->addFormatters(new Formatter\GifFormatter()),
            function ($request) {
                throw new Exception('Something went wrong');
            },
        ], $request);
    ...
    public function testHtmlFormatter()
    {
        ...
        $response = Dispatcher::run([
            (new ErrorHandler())->addFormatters(new Formatter\HtmlFormatter()),
            function ($request) {
                throw new Exception('Something went wrong');
            },
        ], $request);
    ...
    public function testJpegFormatter()
    {
        ...
        $response = Dispatcher::run([
            (new ErrorHandler())->addFormatters(new Formatter\JpegFormatter()),
            function ($request) {
                throw new Exception('Something went wrong');
            },
        ], $request);
    ...
    public function testJsonFormatter()
    {
        ...
        $response = Dispatcher::run([
            (new ErrorHandler())->addFormatters(new Formatter\JsonFormatter()),
            function ($request) {
                throw new Exception('Something went wrong');
            },
        ], $request);
    ...
    public function testPngFormatter()
    {
        ...
        $response = Dispatcher::run([
            (new ErrorHandler())->addFormatters(new Formatter\PngFormatter()),
            function ($request) {
                throw new Exception('Something went wrong');
            },
        ], $request);
    ...
    public function testSvgFormatter()
    {
        ...
        $response = Dispatcher::run([
            (new ErrorHandler())->addFormatters(new Formatter\SvgFormatter()),
            function ($request) {
                throw new Exception('Something went wrong');
            },
        ], $request);
    ...
    public function testXmlFormatter()
    {
        ...
        $response = Dispatcher::run([
            (new ErrorHandler())->addFormatters(new Formatter\XmlFormatter()),
            function ($request) {
                throw new Exception('Something went wrong');
            },
        ], $request);
